...
<section class="relative overflow-hidden pb-16 pt-32 sm:pt-40 lg:pb-24 lg:pt-44">
    ...
    <div class="pointer-events-none absolute inset-x-0 bottom-0 h-40 bg-gradient-to-b from-transparent to-white"></div>
                ...
                <div class="relative mx-auto max-w-md">
                    ...
                    <div class="card overflow-hidden p-8">
                        ...
                        <div class="relative mx-auto grid h-40 w-40 place-items-center">
                            <span class="absolute inset-0 rounded-full border border-ink-200"></span>
                            <span class="absolute inset-4 rounded-full border border-ink-200"></span>
                        ...
                        <div class="mt-3 flex items-center gap-3 rounded-xl border border-volt-500/20 bg-volt-500/10 p-4">
                            <span class="grid h-9 w-9 shrink-0 place-items-center rounded-lg bg-volt-500/20 text-volt-700">
                                <x-icon name="spark" class="h-5 w-5" />
                            </span>
                            <p class="text-xs leading-snug text-ink-600">
                                <span class="font-semibold text-ink-900">Now optimizing</span> for AI Overviews &amp; ChatGPT citations.
                            </p>
                        </div>
                    </div>
                </div>
