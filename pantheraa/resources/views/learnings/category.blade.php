...
>
    <section class="relative overflow-hidden pb-8 pt-36 sm:pt-44">
        ...
        <div class="container-px relative text-center">
            <nav class="flex items-center justify-center gap-2 text-sm text-ink-400" aria-label="Breadcrumb">
            ...
            <p class="mx-auto mt-5 max-w-2xl text-lg text-ink-600" data-hero>
                {{ $category->description ?: 'Everything I\'m learning about ' . $category->name . '.' }}
                <span class="text-ink-400">· {{ $count }} {{ \Illuminate\Support\Str::plural('post', $count) }}</span>
            </p>
        </div>
    </section>
